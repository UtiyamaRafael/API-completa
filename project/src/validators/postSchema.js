...
const createBookSchema = z.object({
  ...
  published_year: z.preprocess((value) => Number(value), z.number().int().positive().optional()),
...
const listLoanSchema = z.object({
  user_id: z.preprocess((value) => Number(value), z.number().int().positive().optional()),
  book_id: z.preprocess((value) => Number(value), z.number().int().positive().optional()),
